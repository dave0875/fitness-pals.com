...
def upgrade() -> None:
    ...
    op.create_index("ix_user_provider_tokens_user_id", "user_provider_tokens", ["user_id"])
    op.create_index("ix_user_provider_tokens_provider", "user_provider_tokens", ["provider"])
