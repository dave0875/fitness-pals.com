...
def upgrade() -> None:
    ...
    op.create_index("ix_published_dossiers_user_id", "published_dossiers", ["user_id"])
    op.create_index("ix_published_dossiers_slug", "published_dossiers", ["slug"], unique=True)
