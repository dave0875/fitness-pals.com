...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_archive_import_jobs_user_id",
        "archive_import_jobs",
        ["user_id"],
    )
    op.create_index(
        "ix_archive_import_jobs_provider",
        "archive_import_jobs",
        ["provider"],
    )
    op.create_index(
        "ix_archive_import_jobs_status",
        "archive_import_jobs",
        ["status"],
    )
    op.create_index(
        "ix_archive_import_jobs_storage_key",
        "archive_import_jobs",
        ["storage_key"],
        unique=True,
    )
